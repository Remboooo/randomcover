...
function randomFont() {
    ...
    fontUrlEnc = font.replace(/ /g, '+');
    fontLink = "<link href='https://fonts.googleapis.com/css?family=" + fontUrlEnc + "' rel='stylesheet' type='text/css'>";
...
$(document).ready(function() {
    var artistFont = randomFont();
    randomizeText($('#artist'));
    randomizeText($('#title'));
});